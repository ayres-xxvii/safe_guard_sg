          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          "View-Only (from Singpass / MyInfo)",
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                  ...
                  // Singpass verified information cards (non-editable)
                  _buildReadOnlyInfoCard(Icons.person, 'Full Name', _fullName),
                  _buildReadOnlyInfoCard(Icons.cake, 'Date of Birth', _dob),
                  _buildReadOnlyInfoCard(Icons.home, 'Address', _address),
                  _buildReadOnlyInfoCard(Icons.email, 'Email', _email),
                  _buildReadOnlyInfoCard(Icons.phone, 'Mobile Number', _phone),
                  
                  // Small note about Singpass verification
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Text(
                          "Verified via Singpass – cannot be changed in-app.",
                          style: TextStyle(
                            fontSize: 12,
